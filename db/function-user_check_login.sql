-- Function: user_check_login(text, text)
--
...
-- DROP FUNCTION user_check_login(text, text);

CREATE OR REPLACE FUNCTION user_check_login(_login_name text, password_plain text)
  RETURNS integer AS
$BODY$
