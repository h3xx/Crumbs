-- Function: crumb_can_reply(integer, character varying, point)
--
...
-- DROP FUNCTION crumb_can_reply(integer, character varying, point);

CREATE OR REPLACE FUNCTION crumb_can_reply(_who integer, _crumb_id character varying, _user_pos point)
  RETURNS boolean AS
$BODY$
...
begin
	...
	select
		into _crumb_pos, _pole_pos, _pole_locked, _pole_distlimit, _owner
		"crumb"."pos", "pole"."pos", "pole"."locked_post", "pole"."post_distlimit", "crumb"."owner"
		from "crumb"
