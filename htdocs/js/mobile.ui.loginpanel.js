...
$.widget("ui.loginpanel", {
	...
	_create: function () {
		...
		uiLoginPanel = (self.uiLoginPanel = $('<div></div>'))
			.addClass('ui-loginpanel ui-widget-header ui-corner-all')
			.append(
				$('<div>Login</div>')
				.addClass('ui-loginpanel-header'),
		...
		self._refresh();
		self.element.append(uiLoginPanel);
	},
